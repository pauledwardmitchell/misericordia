...
ActiveRecord::Schema.define(version: 20171211154229) do
  ...
  create_table "buildings", force: :cascade do |t|
    ...
    t.integer  "annual_elec_usage"
    t.integer  "annual_gas_usage"
  end
  ...
  create_table "copier_contracts", force: :cascade do |t|
    ...
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
    t.float    "total_rebate_to_cpa"
  end

  create_table "copier_invoices", force: :cascade do |t|
  ...
  create_table "monthly_contracts", force: :cascade do |t|
    t.string   "name"
    t.integer  "pw_organization_id"
    t.integer  "building_id"
  ...
  create_table "solar_invoices", force: :cascade do |t|
